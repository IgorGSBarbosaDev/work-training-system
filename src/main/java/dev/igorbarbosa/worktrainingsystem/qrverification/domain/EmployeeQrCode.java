...
public class EmployeeQrCode {
	...
	public UUID getId(){return id;} public UUID getEmployeeId(){return employeeId;} public String getTokenHash(){return tokenHash;} public String getTokenCiphertext(){return tokenCiphertext;} public Status getStatus(){return status;} public Instant getGeneratedAt(){return generatedAt;} public UUID getGeneratedByUserId(){return generatedByUserId;} public Instant getRevokedAt(){return revokedAt;} public UUID getRevokedByUserId(){return revokedByUserId;} public String getRevocationReason(){return revocationReason;}
}
